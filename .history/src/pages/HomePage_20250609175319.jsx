      ...
      >
        <div className="flex flex-col md:flex-row items-center 
          ...
          <div className="flex-1">
            ...
            <p>
            "Hey there! Bring the aroma of tech into your business with Engineer Collins Likhomba — a proficient full-stack web developer ready to turn your ideas into reality."
