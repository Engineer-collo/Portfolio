    ...
    <>
      ...
      <div className="max-w-5xl mx-auto p-4 mt-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Left Info Section */}
          <div className="space-y-4">
            <h3 className="text-xl font-semibold text-blue-600">We'd love to hear from you!</h3>
            <p className="text-gray-600">
              Whether you have a question about our products, sizing, or returns—or just want to say hi—we’re here to help!
            </p>
            <div>
              <p className="text-gray-700 font-medium">
                📞 Phone: <a href="tel:0743250838" className="font-normal text-blue-600 hover:underline">+254 743250838</a>
              </p>
              <p className="text-gray-700 font-medium">
                📧 Email: <a href="mailto:collinslikhomba@gmail.com" className="font-normal text-blue-600 hover:underline">collinslikhomba@gmail.com</a>
              </p>
              <p className="text-gray-700 font-medium">
                📍 Location: <span className="font-normal">Nairobi, Kenya</span>
              </p>
