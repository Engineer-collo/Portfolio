    ...
    <header className="mt-2 bg-white shadow-md relative z-50">
      <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
        <h1 className="text-3xl font-bold text-gray-800">
          <Link to="/" className="hover:text-blue-500 text-gray-700 transition">
      ...
      {isOpen && (
        <div className="fixed top-0 left-0 h-screen w-3/4 bg-white z-50 shadow-lg px-6 py-8 md:hidden">
          ...
          <nav className="space-y-6 mt-10">
            <Link to="/" onClick={toggleMenu} className="block text-gray-700 text-lg hover:text-blue-500">Home</Link>
            <Link to="/about" onClick={toggleMenu} className="block text-gray-700 text-lg hover:text-blue-500">About</Link>
            <Link to="/projects" onClick={toggleMenu} className="block text-gray-700 text-lg hover:text-blue-500">Projects</Link>
            <Link to="/contact" onClick={toggleMenu} className="block text-gray-700 text-lg hover:text-blue-500">Contact</Link>
          </nav>
        </div>
      )}
    </header>
