...
const Navbar = () => {
  ...
  return (
    <header className="bg-white shadow-md relative z-50">
      {/* Top Contact Info */}
      <div className="text-sm md:text-base py-3 px-4 flex flex-wrap items-center gap-4 md:gap-10 border-b border-gray-200">
        <div className=" bg-green-500 flex items-center gap-2">
          <img className="h-5" src="/call.png" alt="Call Icon" />
          <a target="_blank" rel="noopener noreferrer" href="tel:+254743250838" className="text-black hover:underline">
            +254 743 250 838
          </a>
        </div>
