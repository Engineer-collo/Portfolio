...
const Navbar = () => {
  ...
  return (
    <header className="mt-2 bg-white shadow-md relative z-50">
      <div className=' text-2xl pt-12 flex'> 
      <img className='classN h-8' src="/call.png" alt="Call Icon" />
         <h1 className='text-black'>
         <a target='_blank' href="tel:+254743250838" className="hover:underline">+254 743 250 838</a>
         </h1>

         <img className='pl-12 h-8' src="/email.png" alt="Call Icon" />
         <p className='text-black '> 
         <a target='_blank' href="mailto:collinslikhomba@gmail.com" className="hover:underline">collinslikhomba@gmail.com</a>
